...
[[ module: test04
  ...
  [[
    ...
    [ main     <NULL>     ]
    [ $t0       <bool> %ebp-13     ]
    [ $t1       <ptr(4) to <array 10 of <bool>>> %ebp-20     ]
    [ $t10      <ptr(4) to <array 10 of <bool>>> %ebp-24     ]
    [ $t11      <int> %ebp-28     ]
    [ $t12      <int> %ebp-32     ]
    [ $t13      <int> %ebp-36     ]
    [ $t14      <int> %ebp-40     ]
    [ $t2       <int> %ebp-44     ]
    [ $t3       <ptr(4) to <array 10 of <bool>>> %ebp-48     ]
    [ $t4       <int> %ebp-52     ]
    [ $t5       <int> %ebp-56     ]
    [ $t6       <int> %ebp-60     ]
    [ $t7       <int> %ebp-64     ]
    [ $t8       <ptr(4) to <array 10 of <bool>>> %ebp-68     ]
    [ $t9       <int> %ebp-72     ]
  ]]
  [[ test04
      0:     assign i <- 0
