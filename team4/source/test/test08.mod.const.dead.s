...
test:
    ...
    movl    %eax, -68(%ebp)        
    leal    -60(%ebp), %eax         #   1:     &()    *t2 <- &a
    movl    %eax, -116(%ebp)       
    movl    -116(%ebp), %eax        #   2:     param  0 <- t2
    pushl   %eax                   
    ...
    addl    %ebx, %eax             
    movl    %eax, -128(%ebp)       
    movl    -68(%ebp), %eax         #   5:     add    t5 <- t0, t4
    movl    -128(%ebp), %ebx       
    addl    %ebx, %eax             
    movl    %eax, -132(%ebp)       
    ...
    movl    %eax, -64(%ebp)        
l_test_3_while_cond:
    movl    -64(%ebp), %eax         #   9:     if     i < 10 goto 4_while_body
    movl    $10, %ebx              
    cmpl    %ebx, %eax             
...
l_test_4_while_body:
    ...
    subl    %ebx, %eax             
    movl    %eax, -136(%ebp)       
    leal    -60(%ebp), %eax         #  13:     &()    *t7 <- &a
    movl    %eax, -140(%ebp)       
    movl    -64(%ebp), %eax         #  14:     mul    t8 <- i, 4
    movl    $4, %ebx               
    imull   %ebx                   
    movl    %eax, -144(%ebp)       
    leal    -60(%ebp), %eax         #  15:     &()    *t9 <- &a
    movl    %eax, -148(%ebp)       
    movl    -148(%ebp), %eax        #  16:     param  0 <- t9
    pushl   %eax                   
    call    DOFS                    #  17:     call   t10 <- DOFS
    addl    $4, %esp               
    movl    %eax, -76(%ebp)        
    movl    -144(%ebp), %eax        #  18:     add    t11 <- t8, t10
    movl    -76(%ebp), %ebx        
    addl    %ebx, %eax             
    movl    %eax, -80(%ebp)        
    movl    -140(%ebp), %eax        #  19:     add    t12 <- t7, t11
    movl    -80(%ebp), %ebx        
    addl    %ebx, %eax             
    movl    %eax, -84(%ebp)        
    movl    -136(%ebp), %eax        #  20:     assign @t12 <- t6  // *t12 = &a
    movl    -84(%ebp), %edi        
    movl    %eax, (%edi)           
    movl    -64(%ebp), %eax         #  21:     add    t13 <- i, 1
    movl    $1, %ebx               
    addl    %ebx, %eax             
    movl    %eax, -88(%ebp)        
    movl    -88(%ebp), %eax         #  22:     assign i <- t13
    movl    %eax, -64(%ebp)        
...
l_test_10_while_cond:
    movl    -64(%ebp), %eax         #  27:     if     i < 10 goto 11_while_body
    movl    $10, %ebx              
    cmpl    %ebx, %eax             
    jl      l_test_11_while_body   
    jmp     l_test_9                #  28:     goto   9
l_test_11_while_body:
    leal    -60(%ebp), %eax         #  30:     &()    *t14 <- &a
    movl    %eax, -92(%ebp)        
    movl    -64(%ebp), %eax         #  31:     mul    t15 <- i, 4
    movl    $4, %ebx               
    imull   %ebx                   
    movl    %eax, -96(%ebp)        
    leal    -60(%ebp), %eax         #  32:     &()    *t16 <- &a
    movl    %eax, -100(%ebp)       
    movl    -100(%ebp), %eax        #  33:     param  0 <- t16
    pushl   %eax                   
    call    DOFS                    #  34:     call   t17 <- DOFS
    addl    $4, %esp               
    movl    %eax, -104(%ebp)       
    movl    -96(%ebp), %eax         #  35:     add    t18 <- t15, t17
    movl    -104(%ebp), %ebx       
    addl    %ebx, %eax             
    movl    %eax, -108(%ebp)       
    movl    -92(%ebp), %eax         #  36:     add    t19 <- t14, t18
    movl    -108(%ebp), %ebx       
    addl    %ebx, %eax             
    movl    %eax, -112(%ebp)       
    movl    -112(%ebp), %edi       
    ...
    addl    $4, %esp               
    movl    -64(%ebp), %eax         #  39:     add    t20 <- i, 1
    movl    $1, %ebx               
    addl    %ebx, %eax             
    movl    %eax, -120(%ebp)       
    movl    -120(%ebp), %eax        #  40:     assign i <- t20
    movl    %eax, -64(%ebp)        
    jmp     l_test_10_while_cond    #  41:     goto   10_while_cond
l_test_9:
