...
CalcPrimes:
    ...
    movl    %eax, -16(%ebp)        
    movl    -196(%ebp), %eax        #  12:     if     t8 < 1 goto 5_if_true
    movl    $1, %ebx               
    cmpl    %ebx, %eax             
...
l_CalcPrimes_4:
    ...
    addl    %ebx, %eax             
    movl    %eax, -44(%ebp)        
    movl    $1, %eax                #  24:     assign @t12 <- 1  // *t12 = &p
    movl    -44(%ebp), %edi        
    movl    %eax, (%edi)           
    movl    $4, %eax                #  25:     assign t13 <- 4
    movl    %eax, -48(%ebp)        
    ...
    addl    %ebx, %eax             
    movl    %eax, -60(%ebp)        
    movl    $2, %eax                #  30:     assign @t16 <- 2  // *t16 = &p
    movl    -60(%ebp), %edi        
    movl    %eax, (%edi)           
...
l_CalcPrimes_32_if_true:
    ...
    addl    %ebx, %eax             
    movl    %eax, -120(%ebp)       
    movl    -204(%ebp), %eax        #  78:     assign @t31 <- v  // *t31 = &p
    movl    -120(%ebp), %edi       
    movl    %eax, (%edi)           
    ...
    movl    %eax, -28(%ebp)        
    movl    -124(%ebp), %eax        #  81:     if     t32 = t8 goto 38_if_true
    movl    -196(%ebp), %ebx       
    cmpl    %ebx, %eax             
...
l_CalcPrimes_31:
    ...
    imull   %ebx                   
    movl    %eax, -168(%ebp)       
    movl    -132(%ebp), %eax        # 107:     if     t34 > t43 goto 45_if_true
    movl    -168(%ebp), %ebx       
    cmpl    %ebx, %eax             
...
l_CalcPrimes_45_if_true:
    ...
    movl    %eax, -32(%ebp)        
    movl    -172(%ebp), %eax        # 112:     if     t44 >= pidx goto 50_if_true
    movl    -28(%ebp), %ebx        
    cmpl    %ebx, %eax             
