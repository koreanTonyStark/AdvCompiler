...
[[ module: pfact
  ...
  [[
    ...
    [ $t0       <ptr(4) to <array 16 of <char>>> %ebp-16     ]
    [ $t1       <ptr(4) to <array 25 of <char>>> %ebp-20     ]
    [ $t2       <int> %ebp-24     ]
    [ $t3       <ptr(4) to <array 20 of <char>>> %ebp-28     ]
    [ $t4       <ptr(4) to <array 3 of <char>>> %ebp-32     ]
  ]]
  [[ pfact
      0:     &()    *t0 <- &_str_3
      1:     param  0 <- t0
  ...
  [[ procedure: primefactor
    [[
      ...
      [ %n        <int> %ebp+8       ]
      [ $t10      <int> %ebp-20       ]
      [ $t5       <ptr(4) to <array 2 of <char>>> %ebp-24       ]
      [ $t6       <int> %ebp-28       ]
      [ $t7       <int> %ebp-32       ]
      [ $t8       <ptr(4) to <array 2 of <char>>> %ebp-36       ]
      [ $t9       <int> %ebp-40       ]
    ]]
    [[ primefactor
