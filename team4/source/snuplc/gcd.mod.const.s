...
l_gcd_iter_5_if_true:
    ...
    addl    %ebx, %eax             
    movl    %eax, -128(%ebp)       
    movl    -112(%ebp), %eax        #  43:     assign @t39 <- t35  // *t39 = &a
    movl    -128(%ebp), %edi       
    movl    %eax, (%edi)           
    jmp     l_gcd_iter_4            #  44:     goto   4
l_gcd_iter_6_if_false:
    movl    $4, %eax                #  46:     assign t40 <- 4
    movl    %eax, -132(%ebp)       
    ...
    addl    %ebx, %eax             
    movl    %eax, -180(%ebp)       
    movl    -164(%ebp), %eax        #  62:     assign @t52 <- t48  // *t52 = &a
    movl    -180(%ebp), %edi       
    movl    %eax, (%edi)           
l_gcd_iter_4:
    jmp     l_gcd_iter_1_while_cond #  64:     goto   1_while_cond
l_gcd_iter_0:
    movl    $0, %eax                #  66:     assign t53 <- 0
    movl    %eax, -184(%ebp)       
...
l_gcd_mod_2_while_body:
    ...
    movl    %eax, -80(%ebp)        
    movl    -80(%ebp), %edi        
    movl    (%edi), %eax            #  25:     div    t27 <- @t26, t18
    movl    -48(%ebp), %ebx        
    cdq                            
    idivl   %ebx                   
    movl    %eax, -84(%ebp)        
    movl    -84(%ebp), %eax         #  26:     mul    t28 <- t27, t18
    movl    -48(%ebp), %ebx        
    imull   %ebx                   
    movl    %eax, -88(%ebp)        
    movl    -64(%ebp), %edi        
    ...
    addl    %ebx, %eax             
    movl    %eax, -108(%ebp)       
    movl    -92(%ebp), %eax         #  33:     assign @t33 <- t29  // *t33 = &a
    movl    -108(%ebp), %edi       
    movl    %eax, (%edi)           
    movl    $0, %eax                #  34:     assign t34 <- 0
    movl    %eax, -112(%ebp)       
    ...
    addl    %ebx, %eax             
    movl    %eax, -124(%ebp)       
    movl    -48(%ebp), %eax         #  39:     assign @t37 <- t18  // *t37 = &a
    movl    -124(%ebp), %edi       
    movl    %eax, (%edi)           
    jmp     l_gcd_mod_1_while_cond  #  40:     goto   1_while_cond
l_gcd_mod_0:
    movl    $0, %eax                #  42:     assign t38 <- 0
    movl    %eax, -128(%ebp)       
...
l_gcd_rec_2_if_false:
    ...
    movl    %eax, -96(%ebp)        
    movl    -80(%ebp), %edi        
    movl    (%edi), %eax            #  32:     assign @t30 <- @t26  // *t30 = &a
    movl    -96(%ebp), %edi        
    movl    %eax, (%edi)           
    movl    $4, %eax                #  33:     assign t31 <- 4
    movl    %eax, -100(%ebp)       
    ...
    addl    %ebx, %eax             
    movl    %eax, -112(%ebp)       
    movl    -64(%ebp), %eax         #  38:     div    t35 <- t22, @t34
    movl    -112(%ebp), %edi       
    movl    (%edi), %ebx           
    cdq                            
    idivl   %ebx                   
    movl    %eax, -116(%ebp)       
    movl    $4, %eax                #  39:     assign t36 <- 4
    movl    %eax, -120(%ebp)       
    ...
    imull   %ebx                   
    movl    %eax, -136(%ebp)       
    movl    -64(%ebp), %eax         #  45:     sub    t41 <- t22, t40
    movl    -136(%ebp), %ebx       
    subl    %ebx, %eax             
    movl    %eax, -140(%ebp)       
    movl    $4, %eax                #  46:     assign t42 <- 4
    movl    %eax, -144(%ebp)       
    movl    8(%ebp), %eax           #  47:     param  0 <- a
    pushl   %eax                   
    ...
    addl    %ebx, %eax             
    movl    %eax, -156(%ebp)       
    movl    -140(%ebp), %eax        #  51:     assign @t45 <- t41  // *t45 = &a
    movl    -156(%ebp), %edi       
    movl    %eax, (%edi)           
    movl    8(%ebp), %eax           #  52:     param  0 <- a
    pushl   %eax                   
...
ReadNumbers:
    ...
    addl    %ebx, %eax             
    movl    %eax, -40(%ebp)        
    movl    -24(%ebp), %eax         #   9:     assign @t16 <- t12  // *t16 = &n
    movl    -40(%ebp), %edi        
    movl    %eax, (%edi)           
    ...
    addl    %ebx, %eax             
    movl    %eax, -64(%ebp)        
    movl    -48(%ebp), %eax         #  19:     assign @t22 <- t18  // *t22 = &n
    movl    -64(%ebp), %edi        
    movl    %eax, (%edi)           
